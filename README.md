...
ResNet50 | 25.6M | 92.1% | 100+ | Высокая точность, медленный inference
VGG16 | 138M | 90.0% | 500+ | Базовая модель, много параметров
EfficientNetB0 | 5.3M | 93.6% | 35 | Баланс точности и скорости
MobileNetV2 | 3.5M | 90.2% | 25 | Оптимально для embedded систем
YOLOv8 | 25.9M | - | 10 | Детекция объектов в реальном времени
...
RS | Rolled-in scale | Окалина, вдавленная в поверхность при прокатке
Pa | Patches | Участки пониженной отражательной способности
Cr | Crazing | Сетка микротрещин от термического стресса
PS | Pitted surface | Питтинг — точечные углубления в металле
