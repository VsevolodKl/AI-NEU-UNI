...
**Декабрь 2025**  
**GitHub:** [https://github.com/yourusername/NEU-defect-detection](https://github.com/yourusername/NEU-defect-detection)
...
Открытый датасет с реальными изображениями дефектов горяче-катаной стальной ленты (Northeastern University, Китай):
...
**Интерактивное демо:** [results_app.html](results/results_app.html) — визуализация предсказаний (22 мс/inference на GPU T4)

**Графики результатов:**
- [График обучения](results/training_plots/algorithm_4_training.png)
- [Матрица ошибок](results/confusion_matrices/algorithm_4_cm.png)
