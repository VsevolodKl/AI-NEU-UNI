...
**Кривые обучения всех 5 алгоритмов** показывают стабильность и отсутствие переобучения:  
![График обучения](results/image1.jpg)
![График обучения](results/image2.jpg)  
![График обучения](results/image3.jpg)
![График обучения](results/image4.jpg)  
![График обучения](results/image5.png)  
...
Всего праметров: 3,538,984  
Обучаемых: 165,426  
Замороженных: 3,373,558  
Всего слоев: 156  
...
| Алгоритм | Точность | F1 | Потери | Правильных |
|----------|----------|----|--------|------------|
| Алг.1 CNN | 75.8% | 0.74 | 0.89 | 273/360 |
| Алг.2 SVM | 35.2% | 0.34 | - | 127/360 |
| Алг.3 CNN+Dropout | 82.4% | 0.81 | 0.62 | 297/360 |
| **Алг.4 MobileNetV2** | **99.34%** | **0.993** | **0.0426** | **358/360** |
| Алг.5 MobileNetV2 base | 94.53% | 0.943 | 0.18 | 340/360 |
